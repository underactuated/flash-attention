...
void run_mha_bwd_hdim64(Flash_bwd_params &params, cudaStream_t stream) {
    ...
    DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        ...
        if (max_smem_per_block >= 144 * 1024) {
            run_flash_bwd<Flash_bwd_kernel_traits<Headdim, 128, 64, 8, 4, 4, 4, false, false, T>, Is_dropout, Is_causal>(params, stream); // my test
            // run_flash_bwd<Flash_bwd_kernel_traits<Headdim, 128, 128, 8, 4, 4, 4, false, false, T>, Is_dropout, Is_causal>(params, stream);
            ...
            // if (params.h == params.h_k) {
                ...
                //run_flash_bwd<Flash_bwd_kernel_traits<Headdim, 64, 64, 8, 4, 4, 4, true, false, T>, Is_dropout, Is_causal>(params, stream); // my test, experimental
                run_flash_bwd<Flash_bwd_kernel_traits<Headdim, 128, 64, 8, 4, 2, 4, true, false, T>, Is_dropout, Is_causal>(params, stream); // my test
